...
## 2026-08-13 — KD–KN: Morse curvature-volume current

**EXACT PDE GEOMETRY CURRENT.** For a strict maximum G=-Hess(e)>0, incompressibility removes the velocity-gradient connection from d log det(G)/dt. The remaining faces are the Hessian of the exact owner R and relative critical-lineage curvature harvesting.
**RIGOROUS DEGENERATION CURRENCY.** Along a strict critical lineage whose determinant tends to zero, the accumulated negative variation of the exact logarithmic curvature current is infinite. This is a geometry condition, not selector currency.
**EXACT CALIBRATIONS.** Kelvin merger gives quadratic normal-curvature collapse with d-squared scaled log-rate limit -6nu. ABC gives log-volume rate -6nu while its Hessian stays nondegenerate for finite time.

**KD–KN ACTION CERTIFICATE.** Action 31714985899 on theorem SHA d9af664d5c15974b2b1def115fcaad59c48fd92a completed successfully. Exp101 connection residual 9.770e-15; similarity residual 1.597e-15; merger derivative identity 1.627e-16; d-squared log-rate residual 9.409e-17; finite-cutoff negative log-volume drop 2.150569e+01; smallest-d negative log-rate 1.860000e+10; nonlinear-advection residual 0; PASS. No termination or continuation claim.

## 2026-08-13 — KO–KY: record-contact pressure tax and core funding gate

**EXACT RECORD-CONTACT CORE.** In the vorticity frame, strain splits into axial stretch, direction turning, and transverse trace-free shape. Pressure Poisson then forces `N_core=Sigma^2/2+(5/3)B+Theta/3-1/3-Pi_p+V_alpha`, where `Pi_p` is the trace-free directional pressure anisotropy. The constant `-1/3` is the dimensionless incompressibility pressure-trace tax.

**EXACT POSITIVE-RENEWAL FUNDING LAW.** At an increasing running-record contact, `N_rec=-(Sigma^2/2+1/3)+(5/3)B+Theta/3-Pi_p+V_alpha+N_sweep+(Sigma Delta_rec)/2`. The last term is normalization relief, not a source. Positive renewal must beat the rigid tax `Sigma^2/2+1/3`.

**RIGOROUS CAPACITY GATE.** The sharp trace-free pressure inequality `|xi.P^circ.xi|<=sqrt(2/3)|P^circ|` yields a six-channel nonnegative necessary gate; at least one weighted turning/shape/pressure/viscous/sweep/normalization-relief channel exceeds one sixth of the funding tax at every positive-renewal contact. This is admission, not finite total capacity.

**EXACT CALIBRATIONS.** One-mode heat shear pays the `1/3` tax by transverse strain shape with zero core renewal. Constant affine strain-spin pays the complete `Sigma^2/2+1/3` tax by trace-free pressure anisotropy with zero renewal. Accelerating affine strain-spin has pressure-anisotropy excess `a'/Omega^2`, exactly equal to positive renewal.

**OPEN BRIDGE.** Pressure anisotropy is still internally generated by the periodic Poisson/Riesz solve. The remaining question is a true capacity/reuse/nonaccumulation theorem for the named funding channels; no termination/continuation/global-regularity claim.

**KO–KY ACTION CERTIFICATE.** Action 31717325352 on SHA 0a29b89 succeeded. Exp102 funding identity 1.134e-15; sharp pressure saturation 2.952e-16; heat shear core 0; constant affine zero-renewal 1.110e-16; accelerating affine renewal excess 1.116e-16 and renewal=sigma^2 1.860e-16; PASS. No capacity-summability or continuation claim.
